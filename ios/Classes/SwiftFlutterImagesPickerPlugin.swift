...
public class SwiftFlutterImagesPickerPlugin: NSObject, FlutterPlugin, ImagePickerDelegate {
  ...
  public static func register(with registrar: FlutterPluginRegistrar) {
      ...
      let instance = SwiftFlutterImagesPickerPlugin.init(cont: controller, messenger: registrar.messenger())
